...
class requestManager {
    ...
    async setCurrentStream(track) {
        let stream;
        if (this.player.manager.cacheManager.map.has(track.link)) {
            stream = this.player.manager.cacheManager.map.get(track.link);
        }
        ...
        if (this.player.manager.config.cache.enabled && !this.player.manager.cacheManager.map.has(track.link)) {
            this.player.manager.cacheManager.write(track.link, stream);
        }
