...
class AudioPlayer {
    ...
    getQueue(page = 1, limit = 10, format = "{position}) {title} | {requester.user.username}") {
        ...
        const prevTracks = this.queue.slice(0, __classPrivateFieldGet(this, _AudioPlayer_modes, "f").currentTrack);
        const nextTracks = this.queue.slice(__classPrivateFieldGet(this, _AudioPlayer_modes, "f").currentTrack);
