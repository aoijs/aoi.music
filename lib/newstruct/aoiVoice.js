    ...
    if (__classPrivateFieldGet(this, _AoiVoice_bot, "f").functionManager) {
        ...
        // lyrics
        {
            ...
            code: async (d) => {
                ...
                if (!songTitle) {
                    return d.aoiError.fnError(d, "custom", {}, "Usage, Provide a song name.");
                }
                ...
                async function scrapeLyrics(songTitle, artist) {
                    const response = await axios_1.default.get("https://google.com/search", Object.assign(Object.assign({}, requestOptions), { params: { q: `${artist} ${songTitle} lyrics` } }));
