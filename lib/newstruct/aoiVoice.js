...
class AoiVoice {
    constructor(bot, managerConfig) {
        ...
        this.manager = new manager_1.Manager(managerConfig);
        this.prunes = new Map();
        this.cmds = {
    ...
    if (__classPrivateFieldGet(this, _AoiVoice_bot, "f").functionManager) {
        ...
        //join
        {
            ...
            code: async (d) => {
                ...
                let [voiceId = d.member.voice.channelId, selfDeaf = "yes", selfMute = "no", speaker = "yes", debug = "no",] = data.inside.splits;
        ...
        //leave
        {
            ...
            code: async (d) => {
                ...
                const hasPlayer = d.client.voiceManager.manager.players.has(guild.id);
                if (!hasPlayer) {
        ...
        //play
        {
            ...
            code: async (d) => {
                ...
                let trackType;
                if (type === "youtube") {
                    tracks = await (0, search_1.search)(track, enums_1.PlatformType.Youtube, this.manager);
                    trackType = enums_1.PlatformType.Youtube;
                }
                else if (type === "soundcloud") {
                    tracks = await (0, search_1.search)(track, enums_1.PlatformType.SoundCloud, this.manager);
                    trackType = enums_1.PlatformType.SoundCloud;
                }
                else if (type === "spotify") {
                    tracks = await (0, search_1.search)(track, enums_1.PlatformType.Spotify, this.manager);
                    trackType = enums_1.PlatformType.Spotify;
                }
                else if (type === "local") {
                    tracks = await (0, search_1.search)(track, enums_1.PlatformType.LocalFile, this.manager);
                    trackType = enums_1.PlatformType.LocalFile;
                }
                else if (type === "url") {
                    tracks = await (0, search_1.search)(track, enums_1.PlatformType.Url, this.manager);
        ...
        //queue
        {
            ...
            code: async (d) => {
                ...
                const hasPlayer = d.client.voiceManager.manager.players.has(d.guild.id);
                if (!hasPlayer) {
                    return d.aoiError.fnError(d, "custom", {}, "Player Not Found.");
                }
                const player = d.client.voiceManager.manager.players.get(d.guild.id);
        ...
        //addFilter
        {
            ...
            code: async (d) => {
                ...
                if (!this.manager.plugins.get(enums_1.PluginName.Filter)) {
                    return d.aoiError.fnError(d, "custom", {}, "Filter Plugin Not Found.");
                }
                const ffilter = (this.manager.plugins.get(enums_1.PluginName.Filter));
        ...
        //hasplayer
        {
            ...
            code: async (d) => {
                ...
                data.result = d.client.voiceManager.manager.players.has(d.guild.id);
                return {
                    code: d.util.setCode(data),
                };
            },
        ...
        // queueLength
        {
            ...
            code: async (d) => {
                ...
                return {
                    code: d.util.setCode(data, player.queue.length ?? 0),
                };
            },
        }, 
        // voicePing
