...
class AoiVoice extends manager_1.Manager {
    constructor(bot, managerConfig) {
        ...
        this.cmds = {
            ...
            [enums_1.PlayerEvents.TrackAdd]: new discord_js_1.Collection(),
            ...
            if (!cmd.__compiled__) {
                ...
                if (cmd.channel.startsWith("$")) {
                    channel = (await __classPrivateFieldGet(this, _AoiVoice_executor, "f").call(this, __classPrivateFieldGet(this, _AoiVoice_bot, "f"), {
                        ...
                        // @ts-ignore
                        channel: __classPrivateFieldGet(this, _AoiVoice_bot, "f").channels.cache.get(this.prunes.get(player.options.connection.joinConfig.guildId).channel),
                ...
                return await __classPrivateFieldGet(this, _AoiVoice_executor, "f").call(this, __classPrivateFieldGet(this, _AoiVoice_bot, "f"), {
                    ...
                    guild: __classPrivateFieldGet(this, _AoiVoice_bot, "f").guilds.cache.get(player.options.connection.joinConfig.guildId),
                    // @ts-ignore
                    channel: __classPrivateFieldGet(this, _AoiVoice_bot, "f").channels.cache.get(this.prunes.get(player.options.connection.joinConfig.guildId)
                        .channel),
    ...
    if (__classPrivateFieldGet(this, _AoiVoice_bot, "f").functionManager) {
        ...
        //play
        {
            ...
            code: async (d) => {
                ...
                let trackType;
                if (type === "youtube") {
                    tracks = await (0, search_1.search)(track.addBrackets(), enums_1.PlatformType.Youtube, this);
                    trackType = enums_1.PlatformType.Youtube;
                }
                else if (type === "soundcloud") {
                    tracks = await (0, search_1.search)(track.addBrackets(), enums_1.PlatformType.SoundCloud, this);
                    trackType = enums_1.PlatformType.SoundCloud;
                }
                else if (type === "spotify") {
                    tracks = await (0, search_1.search)(track.addBrackets(), enums_1.PlatformType.Spotify, this);
                    trackType = enums_1.PlatformType.Spotify;
                }
                else if (type === "local") {
                    tracks = await (0, search_1.search)(track.addBrackets(), enums_1.PlatformType.LocalFile, this);
                    trackType = enums_1.PlatformType.LocalFile;
                }
                else if (type === "url") {
                    tracks = await (0, search_1.search)(track.addBrackets(), enums_1.PlatformType.Url, this);
        ...
        // loopMode
        {
            ...
            code: async (d) => {
                ...
                const player = d.client.voiceManager.players.get(d.guild.id);
                if (player) {
                    if (![enums_1.LoopMode.None, enums_1.LoopMode.Track, enums_1.LoopMode.Queue].includes(mode)) {
        ...
        // removeTrack
        {
            ...
            code: async (d) => {
                ...
                const player = d.client.voiceManager.players.get(d.guild.id);
                if (isNaN(position))
                    return d.aoiError.fnError(d, "custom", {}, "Invalid Position Provided.");
                if (player)
                    player.removeTrack(Number(position));
                return {
                    code: d.util.setCode(data),
                };
            },
