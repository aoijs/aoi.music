...
exports.YoutubeRelated = exports.YoutubeMix = exports.YoutubeMixVideo = exports.isMix = exports.ytRelatedHTMLParser = exports.ytMixHTMLParser = exports.shuffle = void 0;
...
function YoutubeRelated(data) {
    return data
        ...
        .map((x) => `https://www.youtube.com/watch?v=${x.endScreenVideoRenderer.videoId}`);
}
