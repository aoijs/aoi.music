...
exports.Search = exports.Spotify = exports.Youtube = exports.Attachments = exports.LocalFile = exports.SoundCloud = void 0;
...
const { getTracks } = (0, spotify_url_info_1.default)(node_fetch_1.default);
...
class Search {
    ...
    async search({ query, type, limit = 1, }) {
        ...
        if (type === 0) {
            ...
            result = (await this.youtube.search(query, limit)).map((x) => typeof x === "string" ? x : x.url);
        }
        else if (type === 4) {
