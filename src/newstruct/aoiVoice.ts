...
export class AoiVoice<T> extends Manager {
    ...
    #bindFunctions() {
        ...
        if ( this.#bot.functionManager )
        {
            ...
            {
                // @ts-ignore
                this.#bot.functionManager.createFunction = this.#bot.functionManager.createCustomFunction;
            }
            //@ts-ignore
            this.#bot.functionManager.createFunction(
                      ...
                      //queue
                      {
                          ...
                          code: async (d: any) => {
                              ...
                              const hasPlayer =
                                  d.client.voiceManager.players.has(d.guild.id);
                              if (!hasPlayer) {
                                  return d.aoiError.fnError(
                                      d,
                                      "custom",
